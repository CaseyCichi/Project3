...
import NoTaskImg from '../../styles/images/no-tasks-img.png';
...
class TaskListItem extends Component {
	...
	checkForTasks =
        ...
        return <div>
		    ...
		    <img className="d-block mr-auto ml-auto mt-5 mb-3 p-2 img-fluid" src={NoTaskImg} alt='No Tasks Img' width={470}/>
        </div>
        }else {
      	return <div>
	      	<ul id="task-list">
